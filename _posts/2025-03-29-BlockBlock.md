...
```
<SNIP>
b` a'Vþ¢dipfsX" £tB<·J±N@zõaûN3ªØAðp6úÆã"DdsolcC3@keira[REDACTED]
```
notice `kiera`:`[REDACTED]`
# Keira
...
We can abuse this following this guide: [Privilege Escalation via Pacman](https://thecybersimon.com/posts/Privilege-Escalation-via-Pacman/)
# Root
